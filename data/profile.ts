...
export const profile = {
  ...
  about: [
    '交通工程专业出身，就读于哈尔滨工业大学。在校期间系统学习道路与桥梁相关知识，建立了工程识图、结构认知与工程技术的底子。',
    '2023 到 2025 年，我在保利长大第四分公司做工程技术员，参与公路与桥梁工程的技术管理，涉及项目策划、场站临建、科研及桥面板预制管理。那两年让我养成从施工技术和工程实体去理解项目的习惯——知道一个构件在现场怎么被造出来、成本在哪些环节堆起来，回头看造价数据时，判断就有了着力点。',
    '现在我在江苏交咨（谷德数智）从事工程造价与咨询工作，主要开展工程量、计量计价及造价成果相关业务，并逐步把工程技术经验延伸到全过程造价管理与成本控制。业余时间我在做一件事：把专业约束固化进工具，让重复的检索、计算与格式环节交给系统，把关键判断留给人。',
  ],
